...
const ROUTE_REGISTRY: RouteRegistryEntry[] = [
  ...
  { pathPattern: '/masters/module', label: 'Modules', icon: 'i-streamline-module-three-solid', parentPathPattern: '/masters', adminMenuId: 'modules', adminMenuOrder: 20, helpTopicId: 'masters-and-business', helpVariantId: 'modules' },
  ...
  { pathPattern: '/rbac/roles', label: 'Roles & Permissions', icon: 'i-icon-park-permissions', parentPathPattern: '/rbac', adminMenuId: 'roles', adminMenuOrder: 50, helpTopicId: 'users-and-access', helpVariantId: 'roles-and-permissions' },
  ...
  { pathPattern: '/analytics/dashboards', label: 'Dashboards', icon: 'i-heroicons-document-chart-bar-solid', parentPathPattern: '/', adminMenuId: 'dashboards', adminMenuOrder: 150, helpTopicId: 'reports' },
  ...
  { pathPattern: '/notifications', label: 'Notifications', icon: 'i-heroicons-document-chart-bar-solid', parentPathPattern: '/', adminMenuId: 'notifications', adminMenuOrder: 170, helpTopicId: 'notifications' },
  ...
  { pathPattern: '/workflows', label: 'Workflows', icon: 'i-heroicons-document-text-solid', parentPathPattern: '/', adminMenuId: 'workflow', adminMenuLabel: 'Work Flows', adminMenuOrder: 100, helpTopicId: 'workflows' },
